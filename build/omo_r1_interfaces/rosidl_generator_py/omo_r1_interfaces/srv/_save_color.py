...
class Metaclass_SaveColor_Event(type):
    """Metaclass of message 'SaveColor_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__save_color__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__save_color__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__save_color__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__save_color__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__save_color__event
...
class SaveColor_Event(metaclass=Metaclass_SaveColor_Event):
    """Message class 'SaveColor_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<omo_r1_interfaces/SaveColor_Request, 1>',
        'response': 'sequence<omo_r1_interfaces/SaveColor_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['omo_r1_interfaces', 'srv'], 'SaveColor_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['omo_r1_interfaces', 'srv'], 'SaveColor_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from omo_r1_interfaces.srv import SaveColor_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SaveColor_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SaveColor_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from omo_r1_interfaces.srv import SaveColor_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SaveColor_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SaveColor_Response'"
...
class Metaclass_SaveColor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'omo_r1_interfaces.srv.SaveColor')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from omo_r1_interfaces.srv import _save_color
            ...
            if _save_color.Metaclass_SaveColor_Event._TYPE_SUPPORT is None:
                _save_color.Metaclass_SaveColor_Event.__import_type_support__()


class SaveColor(metaclass=Metaclass_SaveColor):
    from omo_r1_interfaces.srv._save_color import SaveColor_Request as Request
    from omo_r1_interfaces.srv._save_color import SaveColor_Response as Response
    from omo_r1_interfaces.srv._save_color import SaveColor_Event as Event
