...
static const _Calg_Request_type_support_symbol_names_t _Calg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1_interfaces, srv, Calg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1_interfaces, srv, Calg_Request)),
  }
};
...
{
  return &::omo_r1_interfaces::srv::rosidl_typesupport_cpp::Calg_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1_interfaces, srv, Calg_Request)() {
  return get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Request>();
}
...
static const _Calg_Response_type_support_symbol_names_t _Calg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1_interfaces, srv, Calg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1_interfaces, srv, Calg_Response)),
  }
};
...
{
  return &::omo_r1_interfaces::srv::rosidl_typesupport_cpp::Calg_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1_interfaces, srv, Calg_Response)() {
  return get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Response>();
}
...
typedef struct _Calg_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _Calg_Event_type_support_ids_t;

static const _Calg_Event_type_support_ids_t _Calg_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _Calg_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _Calg_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _Calg_Event_type_support_symbol_names_t _Calg_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1_interfaces, srv, Calg_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1_interfaces, srv, Calg_Event)),
  }
};

typedef struct _Calg_Event_type_support_data_t
{
  void * data[2];
} _Calg_Event_type_support_data_t;

static _Calg_Event_type_support_data_t _Calg_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _Calg_Event_message_typesupport_map = {
  2,
  "omo_r1_interfaces",
  &_Calg_Event_message_typesupport_ids.typesupport_identifier[0],
  &_Calg_Event_message_typesupport_symbol_names.symbol_name[0],
  &_Calg_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t Calg_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_Calg_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::omo_r1_interfaces::srv::rosidl_typesupport_cpp::Calg_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1_interfaces, srv, Calg_Event)() {
  return get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Event>();
}
...
static const _Calg_type_support_symbol_names_t _Calg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1_interfaces, srv, Calg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1_interfaces, srv, Calg)),
  }
};
...
static const rosidl_service_type_support_t Calg_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<omo_r1_interfaces::srv::Calg_Event>(),
...
{
  return &::omo_r1_interfaces::srv::rosidl_typesupport_cpp::Calg_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1_interfaces, srv, Calg)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<omo_r1_interfaces::srv::Calg>();
}
